...
class FingerPoseEstimator {
  ...
  estimateFingerCurl(startPoint, midPoint, endPoint) {
    ...
    let mid_end_dist = Math.sqrt(
      mid_end_x_dist * mid_end_x_dist + mid_end_y_dist * mid_end_y_dist + mid_end_z_dist * mid_end_z_dist,
    );

    let cos_in =
      (mid_end_dist * mid_end_dist + start_mid_dist * start_mid_dist - start_end_dist * start_end_dist) /
...
module.exports = FingerPoseEstimator;
